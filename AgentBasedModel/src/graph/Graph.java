...
public class Graph {
	...
	public Graph(int nVertices, double probOfConnect)			//Tworzenie listy sąsiedztwa
	{
	...
	public ArrayList<Integer> returnComponent(int num) //Zwraca list� uczestnik�w komponentu
	{
